...
if st.button("Evaluar presión simbólica"):
    ...
    ax.set_xlabel("Dirección emocional ↔ física")
    ax.set_ylabel("Carga retenida ↕ energía disponible")

    # Variables traducidas simbólicamente a plano
    eje_x = (len(tension) - compromisos)  # tensión física vs compromiso mental
    eje_y = (energia_cont / 10) - deseo_no_ejecutado  # energía vs deseo bloqueado
